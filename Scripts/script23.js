...
document.write("<center><table><tr><td align=center><p class='heading'>Игровое поле компьютера</p></td>"+
"<td align=center><p class='heading'>Ваше игровое поле</p></td></tr><tr><td>");
showGrid(true);
